...
var recetaSchema = new Schema({
  ...
  elaboracion: {type: String, required: false, default: ''},
  medidasPreventivas: [{type: String, required: false}],
  peligrosIngredientes: [{type: String, required: false}],
  peligrosDesarrollo: [{type: String, required: false}],
